...
import {GetIngesta, GetFormatedDate, GetAlergeno} from "./Functions";
...
export default class Alergens extends React.Component {
 ...
 this.setState({
  ...
  const strCall ='https://webrestservice.seral-service.com/AppMenus/Alergenos/001/'+ GLOBAL.idCliente + 
       ...
       <ImageBackground source={background} style={styles.background} resizeMode="cover" blurRadius={2}>
        ...
        <FlatList style={{flex:1, marginBottom:125}}
          ...
          <TouchableOpacity
            ...
            >
            <Image
              source={{ uri: "http://seral-service.com/imagenes/a" + item.Imagen + ".png" }} //source={{ uri: data.item.thumbnailUrl }}
              style={{ width: 40, height: 40, margin: 2 }}
            />
            <View style={{alignItems:"flex-start",flex:1}}>
            <Text style={styles.boldText}>  {GetAlergeno(item.Codigo) }  </Text>
            </View>
          </TouchableOpacity>
            }
