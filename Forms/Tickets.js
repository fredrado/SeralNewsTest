...
export default class Tickets extends React.Component {
 ...
 webCall=()=>{
  ...
  const strCall ='https://webrestservice.seral-service.com/AppTPV/TicketsUser/001/500347/50074/' + GLOBAL.idUsuario
            ...
            <View style={styles.listItem}>
              <View style={{alignItems:"flex-end",flex:1, flexDirection:"row"}} >
                <View style={{alignItems:"flex-start",flex:1, flexDirection:"column"}} >
                  ...
                  <Text style={{height:25}}>Menu: {item.Dieta}</Text>
                  <Text style={{height:25}}>Ingesta: {this.GetItem(item.Ingesta)}</Text>
                </View>
                <Text style={{height:50, fontWeight:"bold", fontSize:35, textAlign:"center", color:"red"}}> {item.Cantidad}</Text>
                </View>
              </View>
            }
