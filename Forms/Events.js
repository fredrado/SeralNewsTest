...
export default class Events extends React.Component {
 ...
 webCall=()=>{
  ...
  const strCall ='https://webrestservice.seral-service.com/AppTPV/Events/001/500064/50113'
          ...
          renderItem={({item}) => 
            ...
            <View style={styles.listItem}>
                ...
                <View style={{alignItems:"center",flex:1}}>
                  <Text style={{fontWeight:"bold"}}>{this.GetFormatedDate(item.Anio + '-' + item.Mes + '-' + item.Dia)} </Text>
                  <Text style={{height:35}}>{item.Descripcion}</Text>
                </View>
